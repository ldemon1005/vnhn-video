            ...
            <div class="row footer-bottom">
                ...
                <div class="footer-right">
                    ...
                    <div class="avatar-cgroup">
                        <a href="{{route('index')}}"><img src="{{asset('/local/resources/assets/images/cgroup.png')}}"></a>
                    </div>
                    <p class="version-mobi">Phiên bản mobile</p>

                    <div class="logo-social">
                        <div class="google-play">
                            <a href="{{route('index')}}"><img src="{{asset('/local/resources/assets/images/google-play.png')}}"></a>
                        </div>
                        <div class="appstrore">
                            <a href="{{route('index')}}"><img src="{{asset('/local/resources/assets/images/appstore.png')}}"></a>
                        </div>
                    </div>
                </div>
            </div>
